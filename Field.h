...
//=================================================================================================
    ...
    struct sVector3d {
         ...
         * Operator <<
         */
        friend std::ostream& operator<<(std::ostream& os, const sVector3d& v){
            os << v.x << " " << v.y << " " << v.z;
            return os;
        }
    };
    ...
    struct sMarker {
         ...
         * Operator <<
         */
        friend std::ostream& operator<<(std::ostream& os, const sMarker& m){
            os << "abs: (" << m.absPos << ") rel polar: (" << m.relPosPolar << ") rel cart: (" << m.relPosCart << ")";
            return os;
        }
...
//=================================================================================================
     ...
     */
    void draw_visible(const Matrix4D& headToFieldT) const;
