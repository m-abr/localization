...
public:
    ...
    //------------------------------- methods exclusive for polar coordinates
    
    /**
     * << Operator
     * @param os output stream
     * @param l this line
     * @return ostream "%f %f %f to %f %f %f" using polar coordinates
     */
    friend std::ostream& operator<<(std::ostream& os, const Line6f& l);

    /**
     * Convert line to string
     * @return string "%f %f %f to %f %f %f" using polar coordinates
     */
